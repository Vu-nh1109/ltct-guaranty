                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($petition->status)
                            ...
                            @case(1)
                            <div class="form-group">
                                <button disabled type="submit" name="action" value="accept">Accepted</button>
                            </div>
                            @break
                            @case(0)
                            <div class="form-group">
                                <button disabled type="submit" class="btn btn-danger" name="action" value="refuse">Refused</button>
                            </div>
                            @break
                        @endswitch
                    </div>
